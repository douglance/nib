...
use crate::core::types::{Annotation, AnnotationType, BlurIntensity, Color, Region};
...
impl BlurTool {
    /// Preview color for blur regions (semi-transparent gray)
    pub const BLUR_PREVIEW_COLOR: Color = Color::rgba(128, 128, 128, 128);
