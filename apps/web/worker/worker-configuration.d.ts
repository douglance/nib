/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/worker-configuration.d.ts` (hash: 262b9facd5f0626481c988a355ae8d24)
// Runtime types generated with workerd@1.20260804.1 2026-08-02 nodejs_compat
interface __BaseEnv_Env {
	ARTIFACTS: R2Bucket;
	DB: D1Database;
	EMAIL: SendEmail;
	METERING_QUEUE: Queue;
	AI: Ai;
	...
	TENANT_GATE: DurableObjectNamespace<import("./src/index").TenantGate>;
	SCHEDULER: DurableObjectNamespace<import("./src/index").GenerationScheduler>;
	TRIAL_GATE: DurableObjectNamespace<import("./src/index").TrialGate>;
	SITE: Fetcher /* nib-site */;
	NIB_SERVICE: Service /* entrypoint NibGlobalEntrypoint from nib-global */;
	GENERATE_WORKFLOW: Workflow<Parameters<import("./src/index").GenerationWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TenantGate" | "GenerationScheduler" | "TrialGate";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_ID" | "ACCESS_TEAM_DOMAIN" | "ACCESS_POLICY_AUD" | "ENVIRONMENT" | "PUBLIC_ORIGIN" | "BETTER_AUTH_URL" | "TURNSTILE_SITE_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "TRIAL_NETWORK_IDENTITIES_30D" | "TRIAL_GLOBAL_DAILY_LIMIT" | "BILLING_PORTAL_CONFIGURATION_ID" | "DEFAULT_PRICE_ID" | "HIGH_PRICE_ID" | "USAGE_PRICE_ID">> {}
}
