...
const INSTALL_PROMPT: &str = r#"Install Nib for me. Follow https://app.nibtool.com/install-agent.md exactly. Configure it globally for this agent, install the Nib UI image skill globally, add the managed Nib instruction to this agent's global instruction file, preserve my existing settings, and verify that the generate_ui tool is available without generating an image."#;
...
const SEO_JSON_LD: &str = r#"{
  ...
  "@graph": [
    {
      "@type": "WebSite",
      "@id": "https://app.nibtool.com/#website",
      "url": "https://app.nibtool.com/",
      "name": "Nib",
      "description": "A UI image generator for AI agents and developer tools."
    },
    {
      "@type": "SoftwareApplication",
      "@id": "https://app.nibtool.com/#software",
      "name": "Nib",
      "url": "https://app.nibtool.com/",
...
async fn home() -> Result {
    view! {
        page_document(
            ...
            canonical: "https://app.nibtool.com/",
            <main>
...
async fn pricing_page() -> Result {
    view! {
        page_document(
            ...
            canonical: "https://app.nibtool.com/pricing",
            <main>pricing()</main>
        )
    }
}
...
async fn account() -> Result {
    view! {
        page_document(
            ...
            canonical: "https://app.nibtool.com/account",
...
async fn docs() -> Result {
    view! {
        page_document(
            ...
            canonical: "https://app.nibtool.com/docs",
            <main class="shell docs">
                ...
                <p>"Sign in with an email magic link or passkey. The CLI opens the same account flow and stores its approved device credential in the system Keychain."</p>
                <pre>"nib auth login\nnib auth status"</pre>
                <h2>"CLI"</h2>
                ...
                <h2 id="mcp">"MCP"</h2>
                <p>"For local stdio MCP, run " <code>"nib --mcp"</code> " after " <code>"nib auth login"</code> ". A Streamable HTTP client connects to " <code>"https://app.nibtool.com/mcp"</code> " for installation and discovery. For tool calls, create an expert token with " <code>"generate:write"</code> " and send it as a bearer credential. The server exposes exactly one tool: " <code>"generate_ui"</code> "."</p>
                ...
                <pre>"https://app.nibtool.com/openapi.json\nhttps://app.nibtool.com/.well-known/skills/generate/SKILL.md"</pre>
                <h2>"References"</h2>
