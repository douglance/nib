...
Nib does not generate HTML. It wraps existing HTML in a chrome that provides libraries, validation, screenshots, editable review, and a feedback bridge back to the terminal.
...
- Interactive artifacts must include a copy/export path or be suitable for nib feedback.
